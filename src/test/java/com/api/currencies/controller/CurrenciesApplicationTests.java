package com.api.currencies.controller;
...
public class CurrenciesApplicationTests {
    ...
    public void postCurrencies() throws Exception {
	    Currency currency = new Currency("postTest","postTest",96710000,692800);
    ...
    public void putCurrencies() throws Exception {
	    // wijzig naam
	    Currency currency = new Currency("putTest","putTest",96710000,692800);
        String currencyString = json(currency);
    ...
    public void deleteCurrencies() throws Exception {
        // post currency 
	    Currency currency = new Currency("deleteTest","deleteTest",96710000,692800);
        String currencyString = json(currency);
